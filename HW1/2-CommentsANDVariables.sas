...
data my_salary_data;
		annual_salary = 500; /* this is so sad, numeric variable */
		annual_dollars = "$500"; /* character variable */
		num_years = 0; /* started in July, numeric variable */
		job_title = "research assistant"; /* character variable */
run;

proc print data = my_salary_data;
run;
